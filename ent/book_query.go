...
func (_q *BookQuery) QueryBookAuthor() *BookAuthorQuery {
...
func (_q *BookQuery) QueryMediaRequest() *MediaRequestQuery {
...
func (_q *BookQuery) Clone() *BookQuery {
	...
	return &BookQuery{
		...
		withBookAuthor:   _q.withBookAuthor.Clone(),
		withMediaRequest: _q.withMediaRequest.Clone(),
...
func (_q *BookQuery) WithBookAuthor(opts ...func(*BookAuthorQuery)) *BookQuery {
	query := (&BookAuthorClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withBookAuthor = query
	return _q
}
...
func (_q *BookQuery) WithMediaRequest(opts ...func(*MediaRequestQuery)) *BookQuery {
	query := (&MediaRequestClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withMediaRequest = query
	return _q
}
...
func (_q *BookQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Book, error) {
	var (
		...
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
			_q.withBookAuthor != nil,
			_q.withMediaRequest != nil,
		}
	)
	...
	if query := _q.withBookAuthor; query != nil {
...
func (_q *BookQuery) loadBookAuthor(ctx context.Context, query *BookAuthorQuery, nodes []*Book, init func(*Book), assign func(*Book, *BookAuthor)) error {
...
func (_q *BookQuery) loadMediaRequest(ctx context.Context, query *MediaRequestQuery, nodes []*Book, init func(*Book), assign func(*Book, *MediaRequest)) error {
