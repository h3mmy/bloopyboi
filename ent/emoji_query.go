...
func (_q *EmojiQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *EmojiQuery) FirstIDX(ctx context.Context) int {
...
func (_q *EmojiQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *EmojiQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *EmojiQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *EmojiQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *EmojiQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(emoji.Table, emoji.Columns, sqlgraph.NewFieldSpec(emoji.FieldID, field.TypeInt))
	_spec.From = _q.sql
