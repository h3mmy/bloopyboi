...
func (_q *EmojiQuery) WithEmojiKeywordScores(opts ...func(*EmojiKeywordScoreQuery)) *EmojiQuery {
	...
	_q.withEmojiKeywordScores = query
	return _q
}
...
func (_q *EmojiQuery) WithNamedEmojiKeywordScores(name string, opts ...func(*EmojiKeywordScoreQuery)) *EmojiQuery {
	...
	if _q.withNamedEmojiKeywordScores == nil {
		_q.withNamedEmojiKeywordScores = make(map[string]*EmojiKeywordScoreQuery)
	}
	_q.withNamedEmojiKeywordScores[name] = query
	return _q
}
