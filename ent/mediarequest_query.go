...
func (mrq *MediaRequestQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (mrq *MediaRequestQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(mediarequest.Table, mediarequest.Columns, sqlgraph.NewFieldSpec(mediarequest.FieldID, field.TypeInt))
	_spec.From = mrq.sql
