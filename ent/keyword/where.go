...
// HasEmojis applies the HasEdge predicate on the "emojis" edge.
func HasEmojis() predicate.Keyword {
...
// HasEmojisWith applies the HasEdge predicate on the "emojis" edge with a given conditions (other predicates).
func HasEmojisWith(preds ...predicate.Emoji) predicate.Keyword {
	return predicate.Keyword(func(s *sql.Selector) {
		step := newEmojisStep()
...
func HasEmojiKeywordScores() predicate.Keyword {
	return predicate.Keyword(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEmojiKeywordScoresWith(preds ...predicate.EmojiKeywordScore) predicate.Keyword {
	return predicate.Keyword(func(s *sql.Selector) {
